...
import org.teleight.teleightbots.codegen.json.deserializer.TelegramMethodDeserializer;
import org.teleight.teleightbots.codegen.json.deserializer.TelegramObjectDeserializer;
...
public class CodeGenerator {
    ...
    public void generateApiClasses(Reader reader) {
        final Gson gson = new GsonBuilder()
                .registerTypeAdapter(TypeName[].class, new ClassNameDeserializer())
                .registerTypeAdapter(TelegramObject.class, new TelegramObjectDeserializer())
                .registerTypeAdapter(TelegramMethod.class, new TelegramMethodDeserializer())
                .create();
